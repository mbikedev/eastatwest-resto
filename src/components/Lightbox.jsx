    ...
    >
      ...
      <div className="relative w-full h-full flex items-center justify-center">
        ...
        <button
          ...
          className="absolute top-4 right-4 md:top-6 md:right-6 z-10 p-3 md:p-4 rounded-full transition-all duration-200 hover:scale-110 hover:opacity-90 backdrop-blur-sm shadow-2xl focus:outline-none focus:ring-4 focus:ring-red-500/50"
