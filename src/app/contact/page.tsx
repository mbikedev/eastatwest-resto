    ...
    <div className={`min-h-screen pt-16 transition-colors duration-300 ${theme === 'dark' ? 'bg-black text-white' : 'bg-white text-gray-900'
      ...
      >
        <div className="max-w-4xl mx-auto text-center relative">
          <m.span className="inline-block text-6xl mb-4 animate-spin" style={{ animationDuration: '3s' }} variants={itemVariants}>
            🌟
          </m.span>
          <m.h2 
          ...
          <m.div className="flex justify-center space-x-6" variants={itemVariants}>
            <a
              href="#"
